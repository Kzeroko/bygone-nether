...
public abstract class ModLists {
	...
	public static final List<ConfiguredStructureFeature<?, ?>> DELTALESS_STRUCTURES = ImmutableList.of(StructureFeature.BASTION_REMNANT, ModConfiguredStructures.CONFIGURED_CATACOMB, ModConfiguredStructures.CONFIGURED_NETHER_FORTRESS, ModConfiguredStructures.CONFIGURED_CITADEL);
